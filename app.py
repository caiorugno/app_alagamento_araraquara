...
with col2:
    st.markdown("""
    <h1 style="margin-bottom: 0;">Radar de Alagamentos – Araraquara, Morada do Sol</h1>
    <p style="margin-top: 0; font-size: 16px;">Desenvolvido em Araraquara – Cidade onde mora o sol</p>
...
tab1, tab2, tab3, tab4, tab5, tab6, tab7, tab_alerta, tab_mapa_chuva = st.tabs([
    "Previsão de Chuva (24h)",
    "Mapa Interativo",
    "Resumo do Clima",
    "Chuva nos Próximos Dias",
    "O que fazer em caso de alagamento",
    "Pontos de Alagamento Monitorados",
    "Sobre o Projeto",
...
with tab6:
    ...
    try:
        ...
        # Mapa com todos os pontos monitorados
